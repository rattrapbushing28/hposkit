  ...
  return (
    <div className="space-y-4">
            ...
            {hasPatchable && verdict.color !== "green" && (
              <div className="flex items-center gap-2">
                <label className="text-xs flex items-center gap-2">
                  ...
                  <span>Confirm auto-patch</span>
                </label>
                <button onClick={handlePatchClick} className={`px-3 py-1.5 rounded-lg bg-gradient-to-r from-wc-purple to-purple-500 text-white text-xs font-medium hover:from-wc-purpleDark hover:to-purple-600 transition-all ${!confirm ? "opacity-50 pointer-events-none" : ""}`}>
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h12a2 2 0 002-2V8a2 2 0 00-2-2h-5" /></svg>
                  Auto-Patch
                </button>
              </div>
            )}
      ...
      <div className="flex gap-2 pt-2">
        {hasPatchable && (
          <button onClick={handlePatchClick} className={`px-4 py-2 rounded-lg bg-gradient-to-r from-wc-purple to-purple-500 text-white text-xs font-medium hover:from-wc-purpleDark hover:to-purple-600 transition-all ${!confirm ? "opacity-50 pointer-events-none" : ""}`}>
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h12a2 2 0 002-2V8a2 2 0 00-2-2h-5" /></svg>
            Auto-Patch All
          </button>
        )}
